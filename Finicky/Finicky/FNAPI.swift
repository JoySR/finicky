...
@objc open class FinickyAPI : NSObject, FinickyAPIExports {
    ...
    class func setContext(_ context: JSContext) {
    ...
    */
    ...
    open class func callUrlHandlers(_ originalUrl: URL, sourceBundleIdentifier: String?, flags : Dictionary<String, Bool>) -> Dictionary<String, AnyObject> {
